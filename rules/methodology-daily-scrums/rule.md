...
![Figure: A burndown chart in visualstudio.com](burndowntfspreview_1711678032256.png)
...
![Figure: A Task Board from Azure DevOps](tfspreviewtaskboard_1711678032256.png)
...
![Figure: Call the Product Owner if you have an Impediment (aka Roadblock)](ProductOwnerTelephone_1711678032255.jpg)
...
![Figure: Daily Scrums will alert everyone if there is a major problem and get all brains aligned in the right direction. There is no sense in putting a Band-Aid on a patient's scraped knee if there is a big knife in his eye!](NewStandUpImage_1711678032255.jpg)
