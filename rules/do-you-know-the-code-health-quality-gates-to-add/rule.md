...
![Figure: Steps to install NuGet Packages](VS-InstallNuGetPackages_1711678032249.png)
...
![Figure: New Roslyn Rule issues raised in Visual Studio Analyzer](VS-RoslynRules_1711678032250.png)
...
![Figure: Addition of CSSLint and ESLint to VS Code Project](vs-code-extensions_1711678032251.png)
...
![Figure: Example completed build definition](VSO-BuildDefinition-V3_1711678032250.png)

![Figure: Example directory for TSLint run commands](VSO-DirectoryExampleV2_1711678032251.png)
...
![Figure: Command line step to remove the config file (tslint.json) after the linter has run](VSO-RemoveConfig_1711678032251.png)
...
![Figure: Steps to add PrimaryBuild variable to build definition](VSO-AddVariableTag_1711678032250.png)
